  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <div class="social-auth-links text-center mb-3">
        <p>- OR -</p>
        <a href="fb_and_google_login/facebook-login.php" class="btn btn-block btn-primary">
          <i class="fab fa-facebook mr-2"></i> Sign in using Facebook
        </a>
        <a href="fb_and_google_login/google-login.php" class="btn btn-block btn-danger">
